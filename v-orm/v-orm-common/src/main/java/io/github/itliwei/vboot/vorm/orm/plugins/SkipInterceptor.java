package io.github.itliwei.vboot.vorm.orm.plugins;
...
/**
 * Mybatis 分页拦截器
 * Created by liwei on 2019/4/14.
 */
@Intercepts({@Signature(type =StatementHandler.class, method = "prepare", args = {Connection.class, Integer.class})})
public class SkipInterceptor implements Interceptor {
    private static final Logger logger = LoggerFactory.getLogger(io.github.itliwei.vboot.vorm.orm.plugins.SkipInterceptor.class);
